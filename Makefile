...
ACLOCAL = ${SHELL} /root/iptables-1.4.19/build-aux/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = arm-fsl-linux-gnueabi-ar
AUTOCONF = ${SHELL} /root/iptables-1.4.19/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /root/iptables-1.4.19/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /root/iptables-1.4.19/build-aux/missing --run automake-1.11
AWK = gawk
...
LD = /home/ubuntu/opt/freescale/usr/local/gcc-4.6.2-glibc-2.13-linaro-multilib-2011.12/fsl-linaro-toolchain/arm-fsl-linux-gnueabi/bin/ld
LDFLAGS = 
LIBOBJS = 
LIBS = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/iptables-1.4.19/build-aux/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /home/ubuntu/opt/freescale/usr/local/gcc-4.6.2-glibc-2.13-linaro-multilib-2011.12/fsl-linaro-toolchain/bin/arm-fsl-linux-gnueabi-nm -B
NMEDIT = 
...
PACKAGE_STRING = iptables 1.4.19
...
VERSION = 1.4.19
abs_builddir = /root/iptables-1.4.19
abs_srcdir = /root/iptables-1.4.19
abs_top_builddir = /root/iptables-1.4.19
abs_top_srcdir = /root/iptables-1.4.19
ac_ct_AR = 
ac_ct_CC = 
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/iptables-1.4.19/build-aux/install-sh
kbuilddir = 
kinclude_CPPFLAGS = 
ksourcedir = 
...
prefix = /root/iptables-1.4.19/install
